...
#
# - docker_rebuild_gramar_tests: dynamically builds a docker image
...
#
#   which means future audits will validate the grammar against the
#   way it presently validates.
#
