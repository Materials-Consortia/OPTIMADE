...
- **Description**: a list of symmetry operations given as general position x, y and z coordinates in algebraic form.
  ...
  In case only Cartesian coordinates are available, these Cartesian coordinates must be converted to fractional coordinates before application of the provided symmetry operations.
