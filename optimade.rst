...
- :field:`x-optimade-property`: Dictionary.
  ...
  **REQUIRED keys:**
  ...
  - :field:`property-format`: String.
    ...
    A client MUST disregard the property definition if the field is not a string on MAJOR.MINOR form or the MAJOR version number specified in the field is unrecognized.
