...
- **Requirements/Conventions**:
  ...
  - **Query**: Support for queries on this property is OPTIONAL.
    If supported, filters MAY support only a subset of comparison operators.
  - MUST have length equal to the number of sites in the structure (first dimension of the list properties `cartesian_site_positions`_ or `fractional_site_positions`_).
