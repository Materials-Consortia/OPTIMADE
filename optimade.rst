...
- **Requirements/conventions**:
  ...
  - :val:`molecular_unit_cell`: same as :val:`"unit_cell"`, but in addition places atoms that are connect by covalent or coordination bonds at a bond distance from each other.
